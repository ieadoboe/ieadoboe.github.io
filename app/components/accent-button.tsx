...
const AccentButton: React.FC<AccentButtonProps> = ({ href, text }) => {
  return (
    <Link
      ...
      bg-zinc-100 dark:bg-zinc-700 hover:bg-zinc-200 dark:hover:bg-zinc-600 transition-all 
      border-2 border-solid border-zinc-900 dark:border-zinc-100 flex items-center justify-center 
