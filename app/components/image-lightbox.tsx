    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-black/0 group-hover:bg-black/10 transition-colors duration-300">
          <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-2 rounded-full bg-white/90 dark:bg-zinc-900/90 backdrop-blur-sm">
            <svg className="h-5 w-5 text-zinc-900 dark:text-zinc-100" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="absolute top-4 left-4 px-3 py-1.5 rounded-lg bg-white/10 backdrop-blur-md text-white text-xs z-10">
            Press <kbd className="px-1.5 py-0.5 rounded bg-white/20 font-mono">ESC</kbd> or click outside to close
          </div>
