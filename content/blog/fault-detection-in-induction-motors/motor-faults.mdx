...
<CenteredImage
  src="./motor-experimental-setup.jpg"
...
<CenteredImage src="./motor-scalogram.png" alt="Scalogram" width={700} />
...
![Architecture of Convolutional Neural Networks](./motor-convnet.jpg)
